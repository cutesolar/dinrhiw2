...
namespace whiteice
{
  namespace math
  {
    ...
    (const matrix< blas_real<float> >& D, matrix< blas_real<float> >& W, bool verbose, const blas_real<float> tolerance) ;
    extern template bool ica< blas_real<double> >
    (const matrix< blas_real<double> >& D, matrix< blas_real<double> >& W, bool verbose, const blas_real<double> tolerance) ;

    
    extern template bool ica< blas_complex<float> >
      (const matrix< blas_complex<float> >& D, matrix< blas_complex<float> >& W, bool verbose, const blas_complex<float> tolerance) ;
    extern template bool ica< blas_complex<double> >
    (const matrix< blas_complex<double> >& D, matrix< blas_complex<double> >& W, bool verbose, const blas_complex<double> tolerance) ;
